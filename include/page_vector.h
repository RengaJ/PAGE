...
namespace PAGE
{
	struct Vector2f	{ float xy[2]; };
	struct Vector3f { float xyz[3]; };
	struct Vector4f { float xyzw[4]; };
	class Vector2
	{
		public:
	...
	class Vector3
	{
		public:
			...
			static Vector2 toVector2(Vector3 &vector) { return vector.toVector2(); }
	...
	class Vector4
	{
		public:
			...
			static Vector2 toVector2(Vector4 &vector) { return vector.toVector2(); }
			static Vector3 toVector3(Vector4 &vector) { return vector.toVector3(); }
